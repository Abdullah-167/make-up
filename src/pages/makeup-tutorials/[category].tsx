...
import { makeUpTutorialCatData } from '../../lib/makeupTutorialData';
...
export async function getStaticPaths() {
    const paths = makeUpTutorialCatData.map((page) => ({
...
export async function getStaticProps({ params }: any) {
    const pageData = makeUpTutorialCatData.find((page) => page.url === params.category);
