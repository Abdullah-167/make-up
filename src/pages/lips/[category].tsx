                        ...
                        <div className='flex items-center max-w-[500px] mx-auto px-5'>
                            ...
                            <div className="relative w-full">
                                ...
                                <input
                                    type="text"
                                    id="voice-search"
                                    className={`text-gray-900 text-sm rounded-lg outline-none border-[1.5px]  block w-full pl-10 p-2.5  dark:text-white  ${scrollDown ? 'placeholder:text-tertiary focus:ring-tertiary focus:border-tertiary' : 'placeholder:text-black focus:ring-black focus:border-black'}`}
