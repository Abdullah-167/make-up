...
const Relevant = () => {
    ...
    return (
        <section className="mx-auto relative sm:py-8  overflow-hidden">
            <Container>
                <p className='text-3xl sm:text-5xl font-semibold text-center pb-5 sm:pb-10'>{`Relevant Posts `}</p>
...
const data = [
    {
        img: '/style.jpg',
        heading: "Planet Museum Planet Museum Planet MuseumPlanet Museum",
