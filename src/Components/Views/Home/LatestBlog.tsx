                            ...
                            <div key={index} className=" shadow-md keen-slider__slide cursor-pointer rounded-md my-2">
                                <div className="relative slide-scale">
                                    ...
                                    <Image
                                        ...
                                        height={500}
                                    />
                                    <div className="effect bg-white absolute top-0 w-2 h-full blur-md z-[100]"></div>
                                    <div className="effect bg-white absolute top-0 left-4 w-2 h-full blur-md z-[100]"></div>
                                </div>
